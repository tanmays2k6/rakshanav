const fs = require('fs');
const path = 'e:/rakshanav-main/rakshanav-main/rakshanav/server/controllers/routeController.js';

let code = `const routeFeatureService = require('../services/routeFeatureService');
...
console.log('Rewrote routeController.js');
