const fs = require('fs');
const path = 'e:/rakshanav-main/rakshanav-main/rakshanav/src/pages/citizen/SafeNavigation.jsx';

const newSafeNavigation = `import React from 'react';
...
fs.writeFileSync(path, newSafeNavigation, 'utf8');
console.log('Rewrote SafeNavigation.jsx');
