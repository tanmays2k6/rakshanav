...
DROP POLICY IF EXISTS "Users can view own medical info" ON public.user_medical_info;
CREATE POLICY "Users can view own medical info" ON public.user_medical_info 
  FOR SELECT USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "Users can insert own medical info" ON public.user_medical_info;
CREATE POLICY "Users can insert own medical info" ON public.user_medical_info 
  FOR INSERT WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "Users can update own medical info" ON public.user_medical_info;
CREATE POLICY "Users can update own medical info" ON public.user_medical_info 
  FOR UPDATE USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "Users can delete own medical info" ON public.user_medical_info;
...
CREATE POLICY "Users can update own sos events" ON public.sos_events 
  FOR UPDATE USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "Users can delete own sos events" ON public.sos_events;
